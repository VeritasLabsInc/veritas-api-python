...
from veritas_api import VeritasAPI, AsyncVeritasAPI, APIResponseValidationError
from veritas_api._types import Omit
from veritas_api._utils import maybe_transform
from veritas_api._models import BaseModel, FinalRequestOptions
from veritas_api._constants import RAW_RESPONSE_HEADER
from veritas_api._exceptions import APIStatusError, APITimeoutError, VeritasAPIError, APIResponseValidationError
from veritas_api._base_client import (
    DEFAULT_TIMEOUT,
    HTTPX_DEFAULT_TIMEOUT,
    BaseClient,
    make_request_options,
)
from veritas_api.types.enrichment_create_bulk_params import EnrichmentCreateBulkParams
...
def _get_open_connections(client: VeritasAPI | AsyncVeritasAPI) -> int:
...
class TestVeritasAPI:
    client = VeritasAPI(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "veritas_api/_legacy_response.py",
                        "veritas_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "veritas_api/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(VeritasAPIError):
            with update_env(**{"VERITAS_API_BEARER_TOKEN": Omit()}):
                client2 = VeritasAPI(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: VeritasAPI) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(VERITAS_API_BASE_URL="http://localhost:5000/from/env"):
            client = VeritasAPI(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: VeritasAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: VeritasAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: VeritasAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = VeritasAPI(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = VeritasAPI(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("veritas_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/enrichments").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/enrichments").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/enrichments").mock(side_effect=retry_handler)

        response = client.enrichments.with_raw_response.create_bulk(candidates=[{"name": "name"}])
    ...
    def test_omit_retry_count_header(
        self, client: VeritasAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.enrichments.with_raw_response.create_bulk(
            candidates=[{"name": "name"}], extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.enrichments.with_raw_response.create_bulk(
            candidates=[{"name": "name"}], extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncVeritasAPI:
    client = AsyncVeritasAPI(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(VeritasAPIError):
            with update_env(**{"VERITAS_API_BEARER_TOKEN": Omit()}):
                client2 = AsyncVeritasAPI(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncVeritasAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(VERITAS_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncVeritasAPI(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncVeritasAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncVeritasAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncVeritasAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncVeritasAPI(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncVeritasAPI(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.enrichments.with_raw_response.create_bulk(candidates=[{"name": "name"}])
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncVeritasAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.enrichments.with_raw_response.create_bulk(
            candidates=[{"name": "name"}], extra_headers={"x-stainless-retry-count": Omit()}
        )
